...
elseif locale == "esES" or locale == "esMX" then
  ...
  L["Load built-in class presets or your own saved configurations. Each preset contains spell sound settings and manual mutes."] = "Carga predefinidos de clase o tus propias configuraciones guardadas. Cada predefinido contiene ajustes de sonido de hechizos y silenciamientos manuales."
...
elseif locale == "ruRU" then
  ...
  L["Load built-in class presets or your own saved configurations. Each preset contains spell sound settings and manual mutes."] = "Загрузите встроенные шаблоны классов или собственные сохранённые конфигурации. Каждый шаблон содержит настройки звуков заклинаний и ручные приглушения."
...
elseif locale == "koKR" then
  ...
  L["Load built-in class presets or your own saved configurations. Each preset contains spell sound settings and manual mutes."] = "내장 직업 프리셋 또는 저장된 설정을 불러옵니다. 각 프리셋에는 주문 소리 설정과 수동 음소거가 포함됩니다."
...
elseif locale == "zhCN" then
  ...
  L["Load built-in class presets or your own saved configurations. Each preset contains spell sound settings and manual mutes."] = "加载内置职业预设或你保存的配置。每个预设包含法术音效设置和手动静音。"
...
elseif locale == "zhTW" then
  ...
  L["Load built-in class presets or your own saved configurations. Each preset contains spell sound settings and manual mutes."] = "載入內建職業預設或你儲存的設定。每個預設包含法術音效設定和手動靜音。"
