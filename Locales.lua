...
if locale == "enUS" or locale == "enGB" then
  ...
  -- Spell editor
  L["Play sound on:"] = "Play sound on:"
  L["Cast complete"] = "Cast complete"
  L["Precast (cast bar start)"] = "Precast (cast bar start)"
  L["Both"] = "Both"
  L["Stop sound after (seconds):"] = "Stop sound after (seconds):"
  L["Clear"] = "Clear"
  L["Set"] = "Set"
  L["Current: "] = "Current: "
  L["Loop"] = "Loop"
  ...
  L["No ambient sound data available."] = "No ambient sound data available."
  L["Muted %d ambient sounds."] = "Muted %d ambient sounds."
...
if locale == "ptBR" then
  ...
  L["Sequence (1 per hit, in order):"] = "Sequência (1 por acerto, em ordem):"
  L["sequence: %d sounds"] = "sequência: %d sons"
  L["Sound mode:"] = "Modo de som:"
  L["Standard"] = "Padrão"
  L["Sequence (1 per hit)"] = "Sequência (1 por acerto)"
  L["Add sound"] = "Adicionar som"
  L["Switch to Standard mode to add random sounds."] = "Mude para o modo Padrão para adicionar sons aleatórios."
  ...
  -- Spell editor
  L["Play sound on:"] = "Tocar som em:"
  L["Cast complete"] = "Conjuração completa"
  L["Precast (cast bar start)"] = "Pré-conjuração (início da barra)"
  L["Both"] = "Ambos"
  L["Stop sound after (seconds):"] = "Parar som após (segundos):"
  L["Clear"] = "Limpar"
  L["Set"] = "Definir"
  L["Current: "] = "Atual: "
  L["Loop"] = "Repetir"
  ...
  L["No ambient sound data available."] = "Nenhum dado de som ambiente disponível."
  L["Muted %d ambient sounds."] = "Silenciados %d sons ambientes."
...
elseif locale == "deDE" then
  ...
  L["Sequence (1 per hit, in order):"] = "Sequenz (1 pro Treffer, in Reihenfolge):"
  L["sequence: %d sounds"] = "Sequenz: %d Klänge"
  L["Sound mode:"] = "Klangmodus:"
  L["Standard"] = "Standard"
  L["Sequence (1 per hit)"] = "Sequenz (1 pro Treffer)"
  L["Add sound"] = "Klang hinzufügen"
  L["Switch to Standard mode to add random sounds."] = "Wechsle zum Standardmodus, um zufällige Klänge hinzuzufügen."
  ...
  -- Spell editor
  L["Play sound on:"] = "Klang abspielen bei:"
  L["Cast complete"] = "Zauber abgeschlossen"
  L["Precast (cast bar start)"] = "Vor dem Zauber (Zauberbalken-Start)"
  L["Both"] = "Beides"
  L["Stop sound after (seconds):"] = "Klang stoppen nach (Sekunden):"
  L["Clear"] = "Löschen"
  L["Set"] = "Setzen"
  L["Current: "] = "Aktuell: "
  L["Loop"] = "Wiederholen"
  ...
  L["No ambient sound data available."] = "Keine Umgebungsklangdaten verfügbar."
  L["Muted %d ambient sounds."] = "%d Umgebungsklänge stummgeschaltet."
...
elseif locale == "frFR" then
  ...
  L["Sequence (1 per hit, in order):"] = "Séquence (1 par coup, dans l'ordre) :"
  L["sequence: %d sounds"] = "séquence : %d sons"
  L["Sound mode:"] = "Mode sonore :"
  L["Standard"] = "Standard"
  L["Sequence (1 per hit)"] = "Séquence (1 par coup)"
  L["Add sound"] = "Ajouter un son"
  L["Switch to Standard mode to add random sounds."] = "Passez en mode Standard pour ajouter des sons aléatoires."
  ...
  L["Tailoring"] = "Couture"
  -- Spell editor
  L["Play sound on:"] = "Jouer le son lors de :"
  L["Cast complete"] = "Incantation terminée"
  L["Precast (cast bar start)"] = "Pré-incantation (début de la barre)"
  L["Both"] = "Les deux"
  L["Stop sound after (seconds):"] = "Arrêter le son après (secondes) :"
  L["Clear"] = "Effacer"
  L["Set"] = "Définir"
  L["Current: "] = "Actuel : "
  L["Loop"] = "Boucle"
  ...
  L["No ambient sound data available."] = "Aucune donnée de son ambiant disponible."
  L["Muted %d ambient sounds."] = "%d sons ambiants coupés."
...
elseif locale == "esES" or locale == "esMX" then
  ...
  L["Sequence (1 per hit, in order):"] = "Secuencia (1 por golpe, en orden):"
  L["sequence: %d sounds"] = "secuencia: %d sonidos"
  L["Sound mode:"] = "Modo de sonido:"
  L["Standard"] = "Estándar"
  L["Sequence (1 per hit)"] = "Secuencia (1 por golpe)"
  L["Add sound"] = "Añadir sonido"
  L["Switch to Standard mode to add random sounds."] = "Cambia al modo Estándar para añadir sonidos aleatorios."
  ...
  -- Spell editor
  L["Play sound on:"] = "Reproducir sonido en:"
  L["Cast complete"] = "Lanzamiento completo"
  L["Precast (cast bar start)"] = "Pre-lanzamiento (inicio de barra)"
  L["Both"] = "Ambos"
  L["Stop sound after (seconds):"] = "Parar sonido después de (segundos):"
  L["Clear"] = "Borrar"
  L["Set"] = "Establecer"
  L["Current: "] = "Actual: "
  L["Loop"] = "Repetir"
  ...
  L["Mute by zone:"] = "Silenciar por zona:"
  L["No ambient sound data available."] = "No hay datos de sonido ambiental disponibles."
  L["Muted %d ambient sounds."] = "Silenciados %d sonidos ambientales."
...
elseif locale == "itIT" then
  ...
  L["Sequence (1 per hit, in order):"] = "Sequenza (1 per colpo, in ordine):"
  L["sequence: %d sounds"] = "sequenza: %d suoni"
  L["Sound mode:"] = "Modalità suono:"
  L["Standard"] = "Standard"
  L["Sequence (1 per hit)"] = "Sequenza (1 per colpo)"
  L["Add sound"] = "Aggiungi suono"
  L["Switch to Standard mode to add random sounds."] = "Passa alla modalità Standard per aggiungere suoni casuali."
  ...
  -- Spell editor
  L["Play sound on:"] = "Riproduci suono su:"
  L["Cast complete"] = "Lancio completato"
  L["Precast (cast bar start)"] = "Pre-lancio (inizio barra lancio)"
  L["Both"] = "Entrambi"
  L["Stop sound after (seconds):"] = "Ferma suono dopo (secondi):"
  L["Clear"] = "Cancella"
  L["Set"] = "Imposta"
  L["Current: "] = "Attuale: "
  L["Loop"] = "Ripeti"
  ...
  L["No ambient sound data available."] = "Nessun dato di suono ambientale disponibile."
  L["Muted %d ambient sounds."] = "Silenziati %d suoni ambientali."
...
elseif locale == "ruRU" then
  ...
  L["Sequence (1 per hit, in order):"] = "Последовательность (1 за удар, по порядку):"
  L["sequence: %d sounds"] = "последовательность: %d звуков"
  L["Sound mode:"] = "Режим звука:"
  L["Standard"] = "Стандартный"
  L["Sequence (1 per hit)"] = "Последовательность (1 за удар)"
  L["Add sound"] = "Добавить звук"
  L["Switch to Standard mode to add random sounds."] = "Переключитесь на Стандартный режим для добавления случайных звуков."
  ...
  -- Spell editor
  L["Play sound on:"] = "Воспроизводить звук при:"
  L["Cast complete"] = "Завершение каста"
  L["Precast (cast bar start)"] = "Начало каста (старт полосы)"
  L["Both"] = "Оба"
  L["Stop sound after (seconds):"] = "Остановить звук через (секунд):"
  L["Clear"] = "Очистить"
  L["Set"] = "Установить"
  L["Current: "] = "Текущий: "
  L["Loop"] = "Повтор"
  ...
  L["No ambient sound data available."] = "Нет данных об окружающих звуках."
  L["Muted %d ambient sounds."] = "Заглушено %d окружающих звуков."
...
elseif locale == "koKR" then
  ...
  L["Sequence (1 per hit, in order):"] = "순서대로 (타격당 1개, 순서대로):"
  L["sequence: %d sounds"] = "순서: %d개 소리"
  L["Sound mode:"] = "소리 모드:"
  L["Standard"] = "표준"
  L["Sequence (1 per hit)"] = "순서대로 (타격당 1개)"
  L["Add sound"] = "소리 추가"
  L["Switch to Standard mode to add random sounds."] = "무작위 소리를 추가하려면 표준 모드로 전환하세요."
  ...
  L["Tailoring"] = "재봉술"
  -- Spell editor
  L["Play sound on:"] = "소리 재생 시점:"
  L["Cast complete"] = "시전 완료"
  L["Precast (cast bar start)"] = "시전 시작 (시전바 시작)"
  L["Both"] = "둘 다"
  L["Stop sound after (seconds):"] = "소리 중지 시간 (초):"
  L["Clear"] = "지우기"
  L["Set"] = "설정"
  L["Current: "] = "현재: "
  L["Loop"] = "반복"
  ...
  L["No ambient sound data available."] = "환경음 데이터를 사용할 수 없습니다."
  L["Muted %d ambient sounds."] = "%d개의 환경음이 음소거되었습니다."
...
elseif locale == "zhCN" then
  ...
  L["Sequence (1 per hit, in order):"] = "序列（每次命中1个，按顺序）："
  L["sequence: %d sounds"] = "序列：%d个音效"
  L["Sound mode:"] = "音效模式："
  L["Standard"] = "标准"
  L["Sequence (1 per hit)"] = "序列（每次命中1个）"
  L["Add sound"] = "添加音效"
  L["Switch to Standard mode to add random sounds."] = "切换到标准模式以添加随机音效。"
  ...
  L["Tailoring"] = "裁缝"
  -- Spell editor
  L["Play sound on:"] = "播放声音于："
  L["Cast complete"] = "施法完成"
  L["Precast (cast bar start)"] = "预施法（施法条开始）"
  L["Both"] = "两者"
  L["Stop sound after (seconds):"] = "停止声音于（秒）："
  L["Clear"] = "清除"
  L["Set"] = "设置"
  L["Current: "] = "当前："
  L["Loop"] = "循环"
  ...
  L["No ambient sound data available."] = "没有可用的环境声音数据。"
  L["Muted %d ambient sounds."] = "已静音%d个环境声音。"
...
elseif locale == "zhTW" then
  ...
  L["Sequence (1 per hit, in order):"] = "序列（每次命中1個，按順序）："
  L["sequence: %d sounds"] = "序列：%d個音效"
  L["Sound mode:"] = "音效模式："
  L["Standard"] = "標準"
  L["Sequence (1 per hit)"] = "序列（每次命中1個）"
  L["Add sound"] = "新增音效"
  L["Switch to Standard mode to add random sounds."] = "切換到標準模式以新增隨機音效。"
  ...
  L["Tailoring"] = "裁縫"
  -- Spell editor
  L["Play sound on:"] = "播放聲音於："
  L["Cast complete"] = "施法完成"
  L["Precast (cast bar start)"] = "預施法（施法條開始）"
  L["Both"] = "兩者"
  L["Stop sound after (seconds):"] = "停止聲音於（秒）："
  L["Clear"] = "清除"
  L["Set"] = "設定"
  L["Current: "] = "目前："
  L["Loop"] = "循環"
  ...
  L["No ambient sound data available."] = "沒有可用的環境聲音資料。"
  L["Muted %d ambient sounds."] = "已靜音%d個環境聲音。"
